...
const messages: Messages = {
  en: {
    ...
    councilRunning: "Running...",
    councilQuestion: "Question",
    councilQuestionPlaceholder: "What should every model answer?",
    councilJudges: "Judges (optional)",
    councilMirror: "Mirror responders",
    councilFinalModel: "Final model (optional)",
    councilFinalModelPlaceholder: "Defaults to first judge",
    councilErrorQuestion: "Enter a question to start.",
    councilErrorModels: "Pick at least two models.",
    councilStage1: "Stage 1 · Candidate responses",
    councilStage2: "Stage 2 · Peer scoring",
    councilStage3: "Stage 3 · Final answer",
    councilLeaderboard: "Leaderboard",
    councilNoJudge: "No judge feedback available.",
    councilNoScores: "No scores yet.",
    councilScoreTotal: "Total {score} / 20",
    councilVotesRank: "Votes {votes} · Rank score {rank}",
    councilChair: "Chair",
  ...
  zh: {
    ...
    councilRunning: "运行中...",
    councilQuestion: "问题",
    councilQuestionPlaceholder: "每个模型要回答的内容",
    councilJudges: "评委（可选）",
    councilMirror: "沿用回答模型",
    councilFinalModel: "最终输出模型（可选）",
    councilFinalModelPlaceholder: "默认使用首个评委模型",
    councilErrorQuestion: "请输入问题。",
    councilErrorModels: "至少选择两个模型。",
    councilStage1: "阶段 1 · 候选回答",
    councilStage2: "阶段 2 · 匿名打分",
    councilStage3: "阶段 3 · 最终答案",
    councilLeaderboard: "排行榜",
    councilNoJudge: "暂无评审反馈。",
    councilNoScores: "暂无得分。",
    councilScoreTotal: "总分 {score} / 20",
    councilVotesRank: "投票 {votes} · 排名分 {rank}",
    councilChair: "主席",
    newDiscussion: "新建讨论",
